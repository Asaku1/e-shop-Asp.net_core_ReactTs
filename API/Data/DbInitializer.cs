...
namespace API.Data
{
    public class DbInitializer
    {
        ...
        public static async Task Initialize(StoreContext context, UserManager<User> userManager)
        {
            ...
            // Add/Track the values in the class "Product.cs", Recall that "Product" was passed to "products"
            foreach (var product in products)
            {
                context.Products.Add(product);
            }

            //Now, save the information you were tracking into the database table "Products"
            //NOTE: context does the job for us.
            context.SaveChanges();
        }
    }
}
